...
# Choose locales.
read -r -p "Please insert the locale you use in this format (xx_XX) exempel (sv_SE): " locale

# Choose keyboard layout.
read -r -p "Please insert the keyboard layout you use (ex. sv-latin1): " kblayout
